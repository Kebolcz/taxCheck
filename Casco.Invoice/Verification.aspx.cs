    ...
    public partial class Verification : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //                if (Request.Form["pData[fpdm]"] != null)
                //                {
                //                    fpdm = Request.Form["pData[fpdm]"];
                //                }
                //                if (Request.Form["pData[fphm]"] != null)
                //                {
                //                    fphm = Request.Form["pData[fphm]"];
                //                }
                //                if (Request.Form["pData[kprq]"] != null)
                //                {
                //                    kprq = Request.Form["pData[kprq]"];
                //                }
                //                if (Request.Form["pData[operateTime]"] != null)
                //                {
                //                    operateTime = Request.Form["pData[operateTime]"];
                //                }
